...
################################################################################
# Form generated from reading UI file 'loginoBNeBW.ui'
##
...
class Ui_sesion(object):
    def setupUi(self, sesion):
        ...
        self.frame.setStyleSheet(u"background: rgb(143, 143, 143);\n"
                                 "border-radius: 20px;\n"
                                 "border: 1px;\n"
                                 "")
        ...
        self.l_user.setStyleSheet(u"color: rgb(0, 0, 0);\n"
        ...
        self.key_result.setGeometry(QRect(200, 310, 231, 20))
