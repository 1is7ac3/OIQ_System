...
################################################################################
## Form generated from reading UI file 'inventaryOVkPWF.ui'
##
...
class Ui_inventory(object):
    def setupUi(self, inventory):
        ...
        self.frame.setGeometry(QRect(0, -20, 1081, 721))
        ...
        self.tree.setGeometry(QRect(0, 100, 691, 491))
        ...
        self.b_up.setGeometry(QRect(720, 30, 141, 36))
        ...
        self.i_fdesc2.setGeometry(QRect(530, 630, 113, 33))
        ...
        self.l_info_exit.setGeometry(QRect(696, 438, 361, 51))
        inventory.setCentralWidget(self.centralwidget)
        self.menu = QMenuBar(inventory)
        self.menu.setObjectName(u"menu")
        self.menu.setGeometry(QRect(0, 0, 1080, 28))
